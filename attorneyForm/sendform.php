...
// define form
$FORM = array(
		'ordering-attorney' => array(
			'name' => 'Ordering Attorney',
		...
		'deadline-due-date' => array(
			'name' => 'Deadline/Due Date',
			'validation' => array('default'),
			'required' => true,
		),
		'statute-of-limitations' => array(
...
if ($SUCCESS)
{
	...
	$formcontent = '';
	$emailtemplate = "<html><head><title>attorneys</title></head><body><table width=\"100%\" border=\"0\" cellspacing=\"0\" cellpadding=\"200\" style=\"background:#98826a; align:center\"><tr><td style=\"vertical-align:top; padding:0; width:200px\"></td><td style=\"vertical-align:top; padding:0;\"><table style=\"width:650px; margin:70px auto; border-collapse:collapse; font:13px sans-serif;\"><tr><td style=\"vertical-align:top; padding:0; height:70px\">&nbsp;</td></tr><tr><td style=\"vertical-align:top; padding:0; padding:0\"><table style=\"width:100%; border-collapse:collapse; border:1px solid #241f1c; border-bottom-color:#6c5d53; border-top-color:#6c5d53; font-size:13px\"><tr style=\"background:white\"><!-- top stripe --><td background=\"http://formbakery.com/stripe.png\" style=\"vertical-align:top; padding:0; background:url(http://formbakery.com/stripe.png) left top no-repeat;\" colspan=\"2\">&nbsp;</td></tr><tr style=\"background:white;\"><td colspan=\"2\" style=\"vertical-align:top; padding:0; padding:40px; font-size:21px; font-weight:bold\">attorneys</td></tr><tr style=\"background:white\"><td style=\"vertical-align:top; padding:0; padding:0 0 0 40px; padding-bottom:20px; width:120px; font-weight:bold\">Ordering Attorney:</td><td style=\"vertical-align:top; padding:0; padding-right:40px; padding-bottom:20px\">{$FORM['ordering-attorney']['value']}</td></tr><tr style=\"background:white\"><td style=\"vertical-align:top; padding:0; padding:0 0 0 40px; padding-bottom:20px; width:120px; font-weight:bold\">Firm Name:</td><td style=\"vertical-align:top; padding:0; padding-right:40px; padding-bottom:20px\">{$FORM['firm-name']['value']}</td></tr><tr style=\"background:white\"><td style=\"vertical-align:top; padding:0; padding:0 0 0 40px; padding-bottom:20px; width:120px; font-weight:bold\">Firm Address:</td><td style=\"vertical-align:top; padding:0; padding-right:40px; padding-bottom:20px\">{$FORM['firm-address']['value']}</td></tr><tr style=\"background:white\"><td style=\"vertical-align:top; padding:0; padding:0 0 0 40px; padding-bottom:20px; width:120px; font-weight:bold\">Phone Number:</td><td style=\"vertical-align:top; padding:0; padding-right:40px; padding-bottom:20px\">{$FORM['phone-number']['value']}</td></tr><tr style=\"background:white\"><td style=\"vertical-align:top; padding:0; padding:0 0 0 40px; padding-bottom:20px; width:120px; font-weight:bold\">Email Address:</td><td style=\"vertical-align:top; padding:0; padding-right:40px; padding-bottom:20px\">{$FORM['email-address']['value']}</td></tr><tr style=\"background:white\"><td style=\"vertical-align:top; padding:0; padding:0 0 0 40px; padding-bottom:20px; width:120px; font-weight:bold\">Contact Person:</td><td style=\"vertical-align:top; padding:0; padding-right:40px; padding-bottom:20px\">{$FORM['contact-person']['value']}</td></tr><tr style=\"background:white\"><td style=\"vertical-align:top; padding:0; padding:0 0 0 40px; padding-bottom:20px; width:120px; font-weight:bold\">Deadline/Due Date:</td><td style=\"vertical-align:top; padding:0; padding-right:40px; padding-bottom:20px\">{$FORM['deadline-due-date']['value']}</td></tr><tr style=\"background:white\"><td style=\"vertical-align:top; padding:0; padding:0 0 0 40px; padding-bottom:20px; width:120px; font-weight:bold\">Statute of Limitations:</td><td style=\"vertical-align:top; padding:0; padding-right:40px; padding-bottom:20px\">{$FORM['statute-of-limitations']['value']}</td></tr><tr style=\"background:white\"><td style=\"vertical-align:top; padding:0; padding:0 0 0 40px; padding-bottom:20px; width:120px; font-weight:bold\">Additional Information:</td><td style=\"vertical-align:top; padding:0; padding-right:40px; padding-bottom:20px\">{$FORM['additional-information']['value']}</td></tr><tr style=\"background:white; padding-bottom:40px\"><td colspan=\"2\" style=\"vertical-align:top; padding:0; padding:40px\">&nbsp;</td></tr></table></td></tr><tr><td style=\"vertical-align:top; padding:0; background:#e3dedb; height:1px; line-height:1px; padding:0; border:10px solid #98826a; border-top:0; border-bottom:0\">&nbsp;</td></tr><tr><td style=\"vertical-align:top; padding:0; height:100px\">&nbsp;</td></tr></table></td><td style=\"vertical-align:top; padding:0; width:200px\"></td></tr></table></body></html>";
